...
trait Strings {
  ...
  val isStop = Set(
    "", "a", "about", "after", "again", "against", "all", "along", "already", "also", "always", "am", "an", "and", "another", "any", "are", "as", "ask", "asked", "asks", "at", "away",
    "back", "be", "became", "because", "become", "been", "before", "began", "begin", "being", "but", "by", 
    "call", "called", "calls", "came", "can", "come", "could",
    ...
    "knew", "know",
    "lay", "left", "less", "let", "like", "little", "long", "look", "looked", "looks",
    ...
    "s'en", "said", "same", "sat", "saw", "say", "see", "seemed", "seems", "shall", "she", "should", "sit", "so", "some", "something", "speak", "speaks", "spoke", "stand", "stands", "stood", "still", "such", "suddenly",
