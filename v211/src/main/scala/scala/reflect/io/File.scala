...
import java.io.{BufferedOutputStream, BufferedWriter, Closeable => JCloseable, File => JFile, FileInputStream, FileOutputStream, IOException, OutputStreamWriter, PrintStream, PrintWriter}
